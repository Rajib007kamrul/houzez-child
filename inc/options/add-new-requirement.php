...
Redux::setSection( 'houzez_options', array(
    'title'  => esc_html__( 'Add New Requirement', 'houzez' ),
    'id'     => 'add-requirement-page',
    'desc'   => '',
    'icon'   => 'el-icon-plus-sign el-icon-small',
    'fields' => array(
        array(
            'id'       => 'requirement_submit_form_type',
            'type'     => 'select',
            'title'    => esc_html__('Add New Requirement Mode', 'houzez'),
            'subtitle' => '',
        ...
        array(
            'id'       => 'requirement_listings_admin_approved',
            'type'     => 'select',
        ...
        array(
            'id'       => 'requirement_edit_listings_admin_approved',
            'type'     => 'select',
        ...
        array(
            'id'       => 'requirement_range-bedsroomsbaths',
            'type'     => 'switch',
        ...
        array(
            'id'       => 'requirement_add_ms_section-start',
            'type'     => 'section',
        ...
        array(
            'id'       => 'requirement_ams_type',
            'type'     => 'switch',
            'title'    => esc_html__( 'Requirement Types', 'houzez' ),
            'desc'     => '',
        ...
        array(
            'id'       => 'requirement_ams_status',
            'type'     => 'switch',
            'title'    => esc_html__( 'Requirement Status', 'houzez' ),
            'desc'     => '',
        ...
        array(
            'id'       => 'requirement_ams_label',
            'type'     => 'switch',
            'title'    => esc_html__( 'Requirement Labels', 'houzez' ),
            'desc'     => '',
        ...
        array(
            'id'     => 'requirement_add_ms_section_end',
        ...
        array(
            'id'       => 'requirement_location_dropdowns',
            'type'     => 'select',
            'title'    => esc_html__('Display Drop-down Menus', 'houzez'),
            'subtitle' => '',
            'desc'     => esc_html__('Select Yes to replace the Requirement Location text fields with drop-down menus in order to select the property City, Area, County/State and Country', 'houzez'),
            'options'  => array(
                'yes'   => esc_html__( 'Yes', 'houzez' ),
                'no'   => esc_html__( 'No', 'houzez' )
            ),
   ...
   /*
        array(
            'id'        => 'requirement_area_prefix_default',
            'type'      => 'select',
        ...
        array(
            'id'       => 'requirement_area_prefix_changeable',
            'type'     => 'switch',
        ...
        array(
            'id'       => 'auto_requirement_id',
            'type'     => 'switch',
            'title'    => esc_html__( 'Auto Generate Requirement ID ?', 'houzez' ),
            'desc'     => '',
        ...
        array(
            'id'        => 'requirement_id_pattern',
            'type'      => 'text',
            'title'     => esc_html__( 'Requirement ID Pattern', 'houzez' ),
            'subtitle'  => esc_html__( "Enter pattern for property id. Example HZ-{ID}", 'houzez' ),
            'default' => '{ID}',
            'required' => array('auto_requirement_id', '=', '1')
        ),
        array(
            'id'        => 'requirement_id_prefix',
            'type'      => 'text',
            'title'     => esc_html__( 'Requirement ID Prefix', 'houzez' ),
            'subtitle'  => esc_html__( "Enter prefix for property id, leave empty if you don't want to show prefix. Example HZ-", 'houzez' ),
            'default' => ''
        ),
        array(
            'id'       => 'requirement_max_prop_images',
            'type'     => 'text',
        ...
        array(
            'id'       => 'requirement_image_max_file_size',
            'type'     => 'text',
        ...
        array(
            'id'       => 'requirement_max_prop_attachments',
            'type'     => 'text',
        ...
        array(
            'id'       => 'requirement_attachment_max_file_size',
            'type'     => 'text',
...
Redux::setSection( 'houzez_options', array(
    ...
    'id'     => 'add-new-requirement-layout-manager',
    'desc'   => '',
    'subsection' => true,
    'fields' => array(
        array(
            'id'      => 'requirement_form_sections',
            'type'    => 'sorter',
            'title'   => 'Add New Requirement Form Layout Manager',
            ...
            'options' => array(
                'enabled'  => array(
                    ...
                    'media'                 => esc_html__('Requirement Media', 'houzez'),
                    'details'               => esc_html__('Requirement Details', 'houzez'),
                    'features'              => esc_html__('Requirement Features', 'houzez'),
                    'location'              => esc_html__('Requirement Location', 'houzez'),
...
$submit_form_fields = array(
    ...
    'property-id' => esc_html__('Requirement ID', 'houzez'),
    'year' => esc_html__('Year Built', 'houzez'),
);

$submit_form_fields = array_merge($submit_form_fields, []);



Redux::setSection( 'houzez_options', array(
    'title'  => esc_html__( 'Show/Hide Form Fields', 'houzez' ),
    'id'     => 'requirement-showhide',
    'desc'   => '',
    'subsection' => true,
    'fields' => array(
        array(
            'id'      => 'requirement_adp_details_fields',
            'type'    => 'sorter',
            'title'   => 'Requirement Detail Section',
            'subtitle'    => 'Drag-and-drop each module to quickly organize the form fields order of Requirement Details section.',
            'options' => array(
        ...
        array(
            'id'       => 'requirement_hide_add_prop_fields',
            'type'     => 'checkbox',
            'title'    => esc_html__( 'Add New Requirement Form Fields', 'houzez' ),
            'desc'     => '',
            'subtitle' => esc_html__('Select which fields you want to disable from the Add New Requirement form', 'houzez'),
            'options'  => array(
                'prop_type' => esc_html__('Requirement Type', 'houzez'),
                'prop_status' => esc_html__('Requirement Status', 'houzez'),
                'prop_label' => esc_html__('Requirement Label', 'houzez'),
                ...
                'video_url' => esc_html__('Requirement Video Url', 'houzez'),
...
$submit_form_required_fields = array(
    ...
    'prop_id' => esc_html__('Requirement ID', 'houzez'),
...
$submit_form_required_fields = array_merge($submit_form_required_fields, []);
...
Redux::setSection( 'houzez_options', array(
    ...
    'fields' => array(
        array(
            'id'       => 'requirement_enable_title_limit',
            'type'     => 'switch',
            'title'    => esc_html__( 'Requirement Title Limit', 'houzez' ),
            'desc'     => '',
        ...
        array(
            'id'       => 'requirement_title_limit',
            'type'     => 'text',
            'title'    => esc_html__( 'Number of Characters', 'houzez' ),
            'subtitle' => esc_html__( 'Enter number of allowed characters.ie 150', 'houzez' ),
            'default'  => '',
            'validate'  => 'numeric',
            'required'  => array('requirement_enable_title_limit', '=', '1'),
        ),
        array(
            'id'       => 'requirement_required_fields',
            'type'     => 'checkbox',
            'title'    => esc_html__( 'Required Fields', 'houzez' ),
            'desc'     => '',
            'subtitle' => esc_html__('Select which fields of the Add New Requirement form are mandatory', 'houzez'),
