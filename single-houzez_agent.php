            ...
            <div class="<?php echo esc_attr($content_classes); ?>">
                ...
                <div id="review-scroll" class="agent-nav-wrap">
                    <ul class="nav nav-pills nav-justified">
                        ...
                        <li class="nav-item">
                            <a href="#tab-requirements" class="nav-link hz-review-tab" data-toggle="pill" role="tab"> <?php esc_html_e('My Requirement', 'houzez'); ?> </a>
                        </li>
                    </ul>
                </div><!-- agent-nav-wrap -->
                ...
                <div class="tab-content" id="tab-content">
                    ...
                    <div class="tab-pane fade" id="tab-requirements">
                        <?php 
                            get_template_part('template-parts/client-requirements/myrequirement');
                            // get_template_part('template-parts/listing/item', $item_layout);
                        ?>
                    </div><!-- tab-pane -->
                </div><!-- tab-content -->
