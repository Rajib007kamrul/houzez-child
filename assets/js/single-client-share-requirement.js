jQuery('document').ready(function(){
    jQuery('.add_to_my_cli_req_data_button').on('click', function(e) {
        e.preventDefault();

        var thisz = jQuery(this);
        var requirement_id = thisz.data('requirement_id');
        ...
        jQuery.ajax({
            ...
            type: "POST",
            data: {
                action: 'sfs_shared_to_my_requirement',
                sf_requirement_id: requirement_id
            },
            success:function(data) {
                ...
                if ( data ) {
                    ...
                    if(data.status == 'success'){
                        thisz.removeClass('add_to_my_cli_req_data_button').addClass('added_to_my_cli_req_data_button');
                        //thisz.;
